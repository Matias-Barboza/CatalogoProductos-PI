<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListadoMarcas.aspx.cs" Inherits="CatalogoProductos_Web.ListadoMarcas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="section-proyect min-height-container justify-content-start">
        ...
        <%if (NoHayMarcasCargadas)
            {%>
        <div class="jumbotron-proyect jumbotron-no-list-grid rounded-3 border shadow">
            <div class="container">
                <h2 class="display-5">NO SE ENCONTRARON MARCAS CARGADAS</h2>
                <p class="lead">Puede agregarlas en cualquier momento.</p>
                <hr class="my-4" />
                <a href="FormularioMarca.aspx" class="btn btn-primary icon-link icon-link-hover arrow-container">Agregar marca ahora...
        ...
        <div class="jumbotron-proyect jumbotron-list-grid rounded-3 border-shadow">
            ...
            <asp:UpdatePanel ID="UpdatePanelPreGridView" ClientIDMode="Static" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="MarcasGridView" AutoGenerateColumns="false" CssClass="table table-striped" runat="server"
                        DataKeyNames="Id" AllowPaging="true" PageSize="10" PagerStyle-CssClass="pagination-proyect" PagerStyle-HorizontalAlign="Center"
                        OnPageIndexChanging="MarcasGridView_PageIndexChanging" OnRowCommand="MarcasGridView_RowCommand">
                        <Columns>
                            ...
                            <asp:ButtonField ButtonType="Link" HeaderText="Acción" HeaderStyle-CssClass="table-dark" AccessibleHeaderText="Acción"
                                ItemStyle-CssClass="has-icon" Text="&#xF4CA;" ItemStyle-HorizontalAlign="Center" CommandName="EditarMarca" />
                        </Columns>
                    </asp:GridView>
                </ContentTemplate>
            </asp:UpdatePanel>
